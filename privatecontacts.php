...
<html>
    ...
    <body>
        <!-- header-->
        <div class="header"> <h2>Private contacts</h2> <h4>Contact Management System</h4> </div>
          <form>      
          <!-- Creating table-->
    ...
    <button style="float: right;"><a href="allcontacts.php" name title="All Contacts" data-toggle="tooltip" id="btn-add" class="btn btn-add">All-Contacts</a></button>
...
require_once 'functions.php';
    ...
    $sql = "SELECT * FROM contacts WHERE category='Private'";
